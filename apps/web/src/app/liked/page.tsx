...
export default function LikedPage() {
  ...
  const fetchPage = useCallback(async (pageNum: number, append: boolean) => {
    ...
    try {
      const r = await api.get('/content/liked', { params: { page: pageNum, limit: PAGE_SIZE } });
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="mb-8">
        ...
        {!loading && (
          <p className="text-gray-500 text-sm mt-1">{total.toLocaleString()} {total === 1 ? 'piece' : 'pieces'} you've liked</p>
        )}
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-24">
          ...
          <p className="text-white font-semibold text-lg mb-2">Nothing liked yet</p>
          <p className="text-gray-500 text-sm mb-8">Hit the like button on any content you enjoy and it'll show up here.</p>
          <Link
            href="/browse"
